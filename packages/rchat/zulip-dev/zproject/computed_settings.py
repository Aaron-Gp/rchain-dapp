...
AUTH_USER_MODEL = "zerver.UserProfile" # ! here is profiles

TEST_RUNNER = "zerver.lib.test_runner.Runner"

ROOT_URLCONF = "zproject.urls" # ! here is urls
...
RATE_LIMITING_RULES = {
    ...
    "authenticate_by_username": [
        (120, 5),  # 5 login attempts within 30 minutes
    ],
...
INTERNAL_BOTS = [
    ...
    {
        "var_name": "EXTENSION_BOT",
        "email_template": "extension-bot@%s",
        "name": "Extension Bot",
    },
]
