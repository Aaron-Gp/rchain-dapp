...
from zerver.views.home import generate_wallet, add_wallet
...
i18n_urls = [
    ...
    path("accounts/register/", accounts_register, name="accounts_register"), # ! REALM_CREATION_CONFIRM
    path(
    ...
    path("generate_wallet/", generate_wallet, name="wallet"),
    path("add_wallet/", add_wallet, name="add_wallet"),
    path("login/", login_page, {"template_name": "zerver/login.html"}, name="login_page"), # !login
